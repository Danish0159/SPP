...
const Users = () => {
  ...
  useEffect(() => {
    if (!users) {
      ...
      if (!searchValues) {
        ...
        dispatch(fetchUsersAr({ user: searchValues.user, category: searchValues.category_en, subCategory: searchValues.subCategory, city: searchValues.city, country: searchValues.country }));
      }
    }
  ...
  useEffect(() => {
    ...
    dispatch(fetchUsersAr({ user: searchValues.user, category: searchValues.category_en, country: searchValues.country, city: searchValues.city, subCategory: step }));
