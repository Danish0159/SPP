...
export const saudiCities = [
  { value: "Abhā", label: "Abhā" },
  { value: "Abqaiq", label: "Abqaiq" },
  { value: "Al-Baḥah", label: "Al-Baḥah" },
  { value: "Al-Dammām", label: "Al-Dammām" },
  { value: "Al-Hufūf", label: "Al-Hufūf" },
  { value: "Al-Jawf", label: "Al-Jawf" },
  { value: "Al-Kharj (oasis)", label: "Al-Kharj (oasis)" },
  { value: "Al-Khubar", label: "Al-Khubar" },
  { value: "Al-Qaṭīf", label: "Al-Qaṭīf" },
  { value: "Al-Ṭaʾif", label: "Al-Ṭaʾif" },
  { value: "ʿArʿar", label: "ʿArʿar" },
  { value: "Buraydah", label: "Buraydah" },
  { value: "Dhahran", label: "Dhahran" },
  { value: "Ḥāʾil", label: "Ḥāʾil" },
  { value: "Jiddah", label: "Jiddah" },
  { value: "Jīzān", label: "Jīzān" },
  { value: "Khamīs Mushayt", label: "Khamīs Mushayt" },
  { value: "King Khalīd Military City", label: "King Khalīd Military City" },
  { value: "Mecca", label: "Mecca" },
  { value: "Medina", label: "Medina" },
  { value: "Najrān", label: "Najrān" },
  { value: "Ras Tanura", label: "Ras Tanura" },
  { value: "Riyadh", label: "Riyadh" },
  { value: "Sakākā", label: "Sakākā" },
  { value: "Tabūk", label: "Tabūk" },
  { value: "Yanbuʿ", label: "Yanbuʿ" },
];