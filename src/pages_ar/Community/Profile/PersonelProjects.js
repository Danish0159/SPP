...
import {
  deleteProjectAr,
  updateProjectAr,
} from "../../../features_ar/profile/profileSlice";
...
const PersonelProjects = ({ handleStep }) => {
  ...
  const { user, isLoading } = useSelector((state) => state.profileAr);
  ...
  function handleProjectUpdate(projectId) {
    const project = user.profile.portfolio.find(
      ...
      <Wrapper>
        ...
        <div className="link__div">
          ...
          <p className="card__subtitle">
            أرسل رابط صفحة المراجعة إلى العميل لأخذ مراجعة لهذا المشروع بمجرد
            النقر على الزر أدناه لنسخ الرابط تلقائيًا.
          </p>
          <button
            onClick={() => {
              ...
              navigator.clipboard.writeText(
                `mahntysa.netlify.app/Reviewar/${user.profile._id}/${projectReviewId}`
              );
            }}
              ...
              {({ getRootProps, getInputProps }) => (
                <div {...getRootProps({ className: "dropzone", style })}>
                  ...
                  {isDragActive ? (
                    ...
                    <p className="drop">
                      قم بسحب 'وإفلات ملفات الصور فقط هنا ، أو انقر لتحديد
                      الملفات
                      <br />
